...
class SpaceParticipant extends EventEmitter {
...
export { ChatClient, HlsRecordPlugin, IdleMonitorPlugin, JanusAudioSink, JanusAudioSource, JanusClient, Logger, MonitorAudioPlugin, RecordToDiskPlugin, Scraper, SearchMode, Space, SpaceParticipant, SttTtsPlugin };
